...
export interface IShorts extends mongoose.Document {
  ...
  durationFormatted: string; // ✅ store formatted string
  views: number;
  isPublished: boolean;
}
...
const shortsSchema = new mongoose.Schema<IShorts>(
  {
    ...
    thumbnailPath: { type: String, required: true, trim: true },
    durationFormatted: { type: String, default: "00:00" }, // ✅ store formatted only
